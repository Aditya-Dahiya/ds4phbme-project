...
**Check the level of air pollution in your area (ug/m3):**
...
flexdashboard::renderValueBox({
  valueBox(round(obj(),2), icon = "smog",color = 'lightblue')
...
**Using an XGBoost Model, We classify this area to be Polluted (Returns 0) or not (Returns 1):**
