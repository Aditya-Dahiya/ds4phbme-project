...
data = ocsdata %>% select(CMAQ,aod,log_pri_length_15000,somehs,log_nei_2008_pm25_sum_10000)
lr_model = readRDS("https://raw.githubusercontent.com/Aditya-Dahiya/ds4phbme-project/main/lr_model.rds")
xgb_model = readRDS(""https://raw.githubusercontent.com/Aditya-Dahiya/ds4phbme-project/main/xgb_model.rds"")
