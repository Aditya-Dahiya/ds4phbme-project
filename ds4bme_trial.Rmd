...
**US EPA Air Pollution Data (PM 2.5)**  
...
We used the Variance Importance Plots method to determine the most important predictors of air pollution data. The code for the VIP determination is contained in the repo.

The plots below show the most important predictors for the linear model.

VIP ranked order of variables here:

knitr::include_graphics(path = "https://github.com/Aditya-Dahiya/ds4phbme-project/blob/main/variables_1?raw=true")

VIP dot plot showing ranked order of variables in order of the top variables important for the prediction of pollution

knitr::include_graphics(path = "https://github.com/Aditya-Dahiya/ds4phbme-project/blob/main/variables_2?raw=true")
