...
### Maxmimum PM 2.5 levels (ug/m3) recorded at each site during the year
...
### Select Counties and Cities to compare
...
load("C:/Users/myste/Documents/Online MPH Johns Hopkins/140.628.01 - Data Science for Public Health I/ds4phbme-project/data/wrangled/Daily_Data_10years.rda")
...
**Note 1: Kindly wait a till the page loads and extracts data off the web.**


**Note 2:** This page extracts data previously scraped and stored in GitHub to ensure quicker response time. Detailed data extraction is in this [R Script](https://github.com/Aditya-Dahiya/ds4phbme-project/blob/main/EPA%20Datasets%20Fetch%20AQSR.R).
